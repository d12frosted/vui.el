...
<table>
  ...
  <tr>
    <td align="center" valign="top" width="50%">
      <a href="docs/examples/17-pixel-width.el"><strong>Pixel Width</strong></a> <sub>(<code>vui-width-mode</code> = <code>char</code>)</sub><br/>
      <sub>emoji, CJK and proportional text drift when widths are counted in characters</sub>
      <br/><br/>
      <a href="docs/images/17-pixel-width-char.png"><img src="docs/images/17-pixel-width-char.png" alt="Pixel width demo in char mode: columns drift" width="400"/></a>
    </td>
    <td align="center" valign="top" width="50%">
      <a href="docs/examples/17-pixel-width.el"><strong>Pixel Width</strong></a> <sub>(<code>vui-width-mode</code> = <code>pixel</code>)</sub><br/>
      <sub>the same table, boxes and flex rows measured in pixels</sub>
      <br/><br/>
      <a href="docs/images/17-pixel-width-pixel.png"><img src="docs/images/17-pixel-width-pixel.png" alt="Pixel width demo in pixel mode: everything aligned" width="400"/></a>
    </td>
  </tr>
</table>
#+end_html
...
| [[file:docs/guide/12-external-updates.org][External Updates]] | Driving a mounted tree from outside |
...
| 16 | [[file:docs/examples/16-sticky-table.el][Sticky Table]]          | A long filterable table whose header stays visible via =:sticky-header=                 |
| 17 | [[file:docs/examples/17-pixel-width.el][Pixel Width]]           | Emoji, CJK and proportional text in tables, boxes and flex; toggle =vui-width-mode= live |
| 18 | [[file:docs/examples/18-variable-pitch.el][Variable Pitch]]        | Pixel layout in a proportional font: bordered tables, boxes and flex under =variable-pitch-mode=, live toggles |
| 19 | [[file:docs/examples/19-responsive-dashboard.el][Responsive Dashboard]]  | Bordered cards reflowing through =vui-grid= and =vui-flex= =:wrap=: columns drop and panels stack as the width shrinks |

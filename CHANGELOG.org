...
- the alignment of the sticky header in =vui-table= when
  =display-line-numbers-mode= is enabled. =:align-to 0= marks the physical
  start of the text area. However, Emacs may insert virtual content at the
  beginning of the text area, such as =line-numbers=. Using =:align-to
  ,(line-number-display-width 'columns)= will align the sticky header correctly.
